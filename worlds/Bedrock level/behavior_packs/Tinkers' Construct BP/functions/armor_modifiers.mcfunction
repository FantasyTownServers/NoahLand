...
effect @a[hasitem={item=strat:plate_leggings_pig_iron_3,location=slot.armor.legs}] speed 1 0 true
...
effect @a[hasitem={item=strat:plate_boots_pig_iron_3,location=slot.armor.feet}] jump_boost 1 0 true
